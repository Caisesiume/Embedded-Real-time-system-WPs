...
#define LIMIT_BLUE_UPPER 15

#define LED_GREEN 8 // Pin for the green LED
#define LIMIT_GREEN_LOWER 15 // Temperature lower limit to light green LED
#define LIMIT_GREEN_UPPER 20

#define LED_YELLOW 12 // Pin for the yellow LED
#define LIMIT_YELLOW_LOWER 20 // Temperature lower limit to light yellow LED
#define LIMIT_YELLOW_UPPER 25

#define LED_RED 13 // Pin for the red LED
#define LIMIT_RED_LOWER 25 // Temperature lower limit to light red LED
